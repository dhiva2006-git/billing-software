"""
Django settings for shopbill project.
ShopBill Pro — Professional Billing Software
"""
...
SECRET_KEY = 'django-insecure-8-p8b!q6=@es!nq^v_kgwn1%*#=g6wa4v9#&@!vzu_2^ew5q%h'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'billing.context_processors.shop_profile_context',
            ],
        },
    },
]
